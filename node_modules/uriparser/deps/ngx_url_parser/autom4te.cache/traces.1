...
m4trace:configure.ac:6: -1- AM_AUTOMAKE_VERSION([1.11.3])
...
@%:@undef HAVE_STDLIB_H])
m4trace:configure.ac:24: -1- AC_DEFINE_TRACE_LITERAL([HAVE_STDLIB_H])
m4trace:configure.ac:24: -1- m4_pattern_allow([^HAVE_STDLIB_H$])
