...
export declare function createEmptyState(urlTree: UrlTree, rootComponent: any): RouterState;
export declare function createEmptyStateSnapshot(urlTree: UrlTree, rootComponent: any): RouterStateSnapshot;
/**
